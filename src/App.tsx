...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-2 py-2 sm:px-3">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-3 liquid-glass rounded-full px-2 py-2.5 sm:px-4 md:px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-medium">tsitsi@graceftji.com</p>
              </div>
            </div>
          </div>
        </div>
